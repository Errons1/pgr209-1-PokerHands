...
public class PokerHands {
    ...
    private final HashMap<Value, Integer> blackValueFrequency = new HashMap<>();
    private final HashMap<Value, Integer> whiteValueFrequency = new HashMap<>();
    private final HashMap<Suit, Integer> blackSuitFrequency = new HashMap<>();
    private final HashMap<Suit, Integer> whiteSuitFrequency = new HashMap<>();
    ...
    public String checkWinner(Card[] blackHand, Card[] whiteHand) {
        ...
        String flushResult = checkFlush();
        if (flushResult != null) return flushResult;


        String straightResult = checkStraight();
        if (straightResult != null) return straightResult;


        String threeOfAKindResult = checkThreeOfAKind();
        if (threeOfAKindResult != null) return threeOfAKindResult;


        String pairAndTwoPairsResult = checkPairAndTwoPairs();
        if (pairAndTwoPairsResult != null) return pairAndTwoPairsResult;


        String highCardResult = checkHighCard(blackHand, whiteHand);
        if (highCardResult != null) return highCardResult;

        return "Tie";
    }

    private static String checkHighCard(Card[] blackHand, Card[] whiteHand) {
        //        --- HighCard ---
    ...
    private String checkPairAndTwoPairs() {
        //        --- Pair ---
